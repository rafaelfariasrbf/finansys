...
@Component({
  ...
  templateUrl: './categoria-lancamento-container.component.html',
  styleUrls: ['./categoria-lancamento-container.component.scss']
})
export class CategoriaLancamentoContainerComponent {
    ...
    ngOnInit(): void {
        ...
        this._breadcrumbItems = [
          { label: 'Categorias de Lançamento' },
        ];
